...
public class retrieveDatabaseData {
    ...
    // construction method
    public retrieveDatabaseData(String cardNumber, int pin, int customerID, ArrayList<Integer> accounts,
            ArrayList<Double> amounts, ArrayList<String> accountType, String firstName, String lastName,
            String dateOfBirthday, String cardholderName) {
